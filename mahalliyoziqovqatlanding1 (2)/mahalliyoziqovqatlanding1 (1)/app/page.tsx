...
import { ShoppingCart, MapPin, Phone, Star, CheckCircle, Users, MessageCircle } from "lucide-react"
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="px-4 lg:px-6 h-16 flex items-center border-b bg-white sticky top-0 z-50">
        <div className="flex items-center justify-center">
          <Image src="/images/logo.png" width={32} height={32} alt="BAND Logo" className="h-8 w-8" />
      ...
      <main className="flex-1">
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4 mx-24">
                <div className="space-y-2">
                  <Badge className="bg-green-100 text-green-800 hover:bg-green-100">Yangi xizmat</Badge>
              ...
              <div className="flex items-center justify-center">
                <Image
                  src="/images/hero-phone-groceries.png"
                  width={800}
                  height={600}
        ...
        {/* Features Section */}
        <section id="xizmatlar" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 mx-36">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-gray-900">✨ Afzalliklarimiz</h2>
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-xl mb-2">1. Mahsulotni oldindan band qilish</CardTitle>
              ...
              <Card className="border-2 hover:border-green-200 transition-all duration-300 hover:shadow-lg">
                <CardHeader className="pb-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-xl mb-2">2. Vaqtingizni tejang</CardTitle>
                      <CardDescription className="text-base leading-relaxed">
              ...
              <Card className="border-2 hover:border-green-200 transition-all duration-300 hover:shadow-lg">
                <CardHeader className="pb-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-xl mb-2">3. Narxlarni oldindan ko'rish imkoniyati</CardTitle>
                      <CardDescription className="text-base leading-relaxed">
              ...
              <Card className="border-2 hover:border-green-200 transition-all duration-300 hover:shadow-lg">
                <CardHeader className="pb-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-xl mb-2">4. Yaroqlilik muddatiga e'tibor bering</CardTitle>
                      <CardDescription className="text-base leading-relaxed">
              ...
              <Card className="border-2 hover:border-green-200 transition-all duration-300 hover:shadow-lg">
                <CardHeader className="pb-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-xl mb-2">5. Mahsulotlar sonini ko'ring</CardTitle>
                      <CardDescription className="text-base leading-relaxed">
              ...
              <Card className="border-2 hover:border-green-200 transition-all duration-300 hover:shadow-lg">
                <CardHeader className="pb-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-xl mb-2">6. Xabarnomalar va eslatmalar</CardTitle>
                      <CardDescription className="text-base leading-relaxed">
            ...
            <div className="mx-auto max-w-4xl">
              <div className="grid gap-8 md:gap-12">
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  <div className="flex h-20 w-20 items-center justify-center rounded-full bg-green-600 text-white text-2xl font-bold shadow-lg">
                    1
                  </div>
                  <Card className="flex-1 border-2 border-green-200 bg-white shadow-lg">
                    <CardHeader className="pb-4">
                      <CardTitle className="text-xl text-green-800">Ro'yxatdan o'ting yoki kirish qiling</CardTitle>
                ...
                <div className="flex flex-col md:flex-row-reverse items-center gap-6 md:gap-8">
                  <div className="flex h-20 w-20 items-center justify-center rounded-full bg-blue-600 text-white text-2xl font-bold shadow-lg">
                    2
                  </div>
                  <Card className="flex-1 border-2 border-blue-200 bg-white shadow-lg">
                    <CardHeader className="pb-4">
                      <CardTitle className="text-xl text-blue-800">Mahsulotlarni ko'rib chiqing</CardTitle>
                      <CardDescription className="text-base">
                ...
                {/* Step 3 */}
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  <div className="flex h-20 w-20 items-center justify-center rounded-full bg-purple-600 text-white text-2xl font-bold shadow-lg">
                    3
                  </div>
                  <Card className="flex-1 border-2 border-purple-200 bg-white shadow-lg">
                    <CardHeader className="pb-4">
                      <CardTitle className="text-xl text-purple-800">Kerakli mahsulotni tanlang</CardTitle>
                      <CardDescription className="text-base">
                ...
                {/* Step 4 */}
                <div className="flex flex-col md:flex-row-reverse items-center gap-6 md:gap-8">
                  <div className="flex h-20 w-20 items-center justify-center rounded-full bg-orange-600 text-white text-2xl font-bold shadow-lg">
                    4
                  </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 mx-36">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-gray-900">Mahsulot turlari</h2>
                <p className="max-w-[900px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Barcha turdagi oziq-ovqat mahsulotlarini band qilishingiz mumkin
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-4 md:grid-cols-2 grid-cols-1">
              {[
                {
                  name: "Meva-sabzavot",
                  emoji: "🍎🥕",
                ...
                >
                  <CardHeader className="text-center p-6">
                    <div
                      className={`mx-auto h-24 w-24 rounded-full ${category.bgColor} flex items-center justify-center mb-4`}
                    >
                      <span className="text-4xl">{category.emoji}</span>
                    </div>
                    <CardTitle className={`text-lg mb-2 ${category.textColor}`}>{category.name}</CardTitle>
                    <CardDescription className="text-sm font-medium">{category.count} mahsulot</CardDescription>
                  </CardHeader>
                </Card>
              ))}
            </div>
          ...
          <div className="container px-4 md:px-6 mx-36">
            <div className="grid gap-6 lg:grid-cols-4 md:grid-cols-2">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="text-green-100">Faol mijozlar</div>
              </div>
              <div className="flex flex-col items-center text-center">
                <ShoppingCart className="h-12 w-12 mb-4" />
                <div className="text-3xl font-bold">50,000+</div>
                <div className="text-green-100">Band qilingan mahsulot</div>
              </div>
              <div className="flex flex-col items-center text-center">
                <MapPin className="h-12 w-12 mb-4" />
                <div className="text-3xl font-bold">200+</div>
                <div className="text-green-100">Hamkor do'konlar</div>
              </div>
              <div className="flex flex-col items-center text-center">
                <Star className="h-12 w-12 mb-4" />
                <div className="text-3xl font-bold">4.8/5</div>
                <div className="text-green-100">Mijoz baholari</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 mx-36">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mx-36">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-gray-900">
      ...
      <footer
        id="aloqa"
        className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-gray-50 mx-px"
      >
        <div className="container mx-36">
          <div className="grid gap-8 lg:grid-cols-4 md:grid-cols-2">
            <div className="space-y-4">
              <div className="flex items-center">
                <Image src="/images/logo.png" width={24} height={24} alt="BAND Logo" className="h-6 w-6" />
